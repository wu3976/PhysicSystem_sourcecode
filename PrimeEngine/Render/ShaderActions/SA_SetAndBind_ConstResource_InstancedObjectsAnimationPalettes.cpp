...
#include "SA_SetAndBind_ConstResource_InstancedObjectsAnimationPalettes.h"
...
void SA_SetAndBind_ConstResource_InstancedObjectsAnimationPalettes::bindToPipeline(Effect *pCurEffect /* = NULL*/)
{
#	if APIABSTRACTION_D3D11
	...
	PrimitiveTypes::UInt32 slotId = 64;
...

	{
		...
		pBuf = SA_SetAndBind_ConstResource_InstancedObjectsAnimationPalettes::s_pBuffer;
	}
...
void SA_SetAndBind_ConstResource_InstancedObjectsAnimationPalettes::unbindFromPipeline(Components::Effect *pCurEffect /* = NULL*/)
{
	PrimitiveTypes::UInt32 slotId = 64;
	ID3D11ShaderResourceView *pView = NULL;
...
void SA_SetAndBind_ConstResource_InstancedObjectsAnimationPalettes::releaseData()
{
}
