...
if (outputDebugString ~= nil) then
    outputDebugString("Initializing LuaEnvironment[Lua]\n")
end
...
outputDebugString("PE: Client: creating Lua command server at "..intetaddr..":"..tostring(portNum).."\n")
